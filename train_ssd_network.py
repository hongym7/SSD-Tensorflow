...
tf.app.flags.DEFINE_string(
    'train_dir', './logs/imagenet_non_bbox2/',
...
tf.app.flags.DEFINE_integer(
    'num_classes', 1001, 'Number of classes to use in the dataset.')
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')
tf.app.flags.DEFINE_string(
    #'dataset_dir', './tfrecords', 'The directory where the dataset files are stored.')
    'dataset_dir', '/mnt/disk2/tmp_non_bbox_process', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_integer(
    'labels_offset', 0,
...
# =========================================================================== #
tf.app.flags.DEFINE_string(
    'checkpoint_path', './logs/imagenet_non_bbox/model.ckpt-51564',
