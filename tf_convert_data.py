...
from datasets import imagenet_to_tfrecords
...
tf.app.flags.DEFINE_string(
    'dataset_dir', '../dl_data/imagenet/train/',
    'Directory where the original dataset is stored.')
tf.app.flags.DEFINE_string(
    'output_name', 'imagenet_test',
...
def main(_):
    ...
    if FLAGS.dataset_name == 'pascalvoc':
        ...
        imagenet_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
