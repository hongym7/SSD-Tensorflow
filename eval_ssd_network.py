...
tf.app.flags.DEFINE_string(
    'checkpoint_path', './logs/imagenet_non_bbox/',
    'The directory where the model was written to or an absolute path to a '
    'checkpoint file.')
tf.app.flags.DEFINE_string(
    'eval_dir', './logs/eval', 'Directory where the results are saved to.')
tf.app.flags.DEFINE_integer(
...
tf.app.flags.DEFINE_string(
    ...
    'dataset_dir', '/mnt/disk2/tmp', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_string(
